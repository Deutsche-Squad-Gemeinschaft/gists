...
readarray -t OfficalMaps < <(curl -s https://raw.githubusercontent.com/Deutsche-Squad-Gemeinschaft/gists/master/data/MapRotation.cfg | sed -r '/^\s*$/d' | sed 's/[ \t]*$//' | sed 's/\r//g')
